...
<main>
        <form action="app/updatePwdFinal&token=<?=$token?>" auto-complete="off"  method="post" class="form_style">

            <!-- <h3 class="title_form">Leenkons-nous !</h3> -->
            <h3 class="title_form">Reinitialiser mon mot de passe : </h3>
             
            <input type="password" class="form_input_login height_class" id="pwd" name="newPassword"
...
<script>$('#connexionSubmit').click(function(e) {
